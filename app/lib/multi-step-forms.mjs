...
export const CHAIN_FORM_SPECS = {
  temiruDesirePast: { base:'temiru', tail:'taiPast', label:'試す・願望・過去', title:'尝试・愿望・过去',
    kcId:'compound.chain.temiru-desire-past', words:[...voluntary,'脱ぐ','稼ぐ','注ぐ','探す','直す','出す','押す'],
  ...
  passiveProgressivePast: { base:'passive', tail:'teiruPast', label:'受身・状態・過去', title:'受身・进行／状态・过去',
    kcId:'compound.chain.passive-progressive-past', words:['書く','読む','使う','作る','売る','買う','送る','運ぶ','開ける','閉める','教える','呼ぶ','選ぶ','直す','建てる','守る','調べる','愛する','洗う','払う','扱う','疑う','雇う'],
