...
const CONSTRUCTION_SEMANTICS = {
  ...
  teoku: semantic("预先做……／保持……", "表示为将来预先完成动作，或做完后让结果状态保持不变。", {
    usageNote: "接「ほうがよかった」等建议或评价时，整句可表示本该事先如此，不等于该动作确实已经发生。",
  ...
  teiku: semantic("继续下去／向远处而去", "表示动作或状态从某个时点向后持续、变化向后发展，或动作在空间上远离说话人。", {
    usageNote: "不一定表示逐渐变成另一状态；例如「今の人数で足りていくか」问现有人数今后是否持续够用。",
...
const COMPOUND_MEANINGS = {
  ...
  teiku: {
    past: ["继续……下去了／……而去了", "表示动作或状态从过去某时持续下去、变化继续发展，或当时伴随某个动作向远离说话人的方向移动。"],
