...
const COMPOUND_MEANINGS = {
  ...
  teiku: {
    past: ["继续……下去了／……而去了", "表示动作或变化从过去某时继续发展，或当时伴随某个动作向远离说话人的方向移动。"],
    negative: ["不继续……下去／不……而去", "表示动作或变化不继续发展，或不伴随某个动作向远离说话人的方向移动。"],
    negativePast: ["当时没有继续……下去／没有……而去", "表示过去某时动作或变化没有继续发展，或当时没有伴随某个动作向远离说话人的方向移动。"],
  },
  tekuru: {
    past: ["逐渐……起来了／……而来了／……后回来了", "表示动作或变化发展到了某个时点、伴随某个动作朝说话人移动，或做完某事后返回。"],
    negative: ["没有逐渐……起来／不……而来／不去……再回来", "表示相应的变化没有出现、不伴随某个动作朝说话人移动，或不去做某事后返回。"],
    negativePast: ["当时没有逐渐……起来／没有……而来／当时没有去……再回来", "表示过去某时相应的变化没有出现、没有伴随某个动作朝说话人移动，或没有去做某事后返回。"],
  },
  sugiru: {
