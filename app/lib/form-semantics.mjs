...
const CONSTRUCTION_SEMANTICS = {
  ...
  teshimau: semantic("做完……／不小心……", "表示动作彻底完成，也可表达遗憾、意外或不由自主的语感；否定形由完整语境决定是未完成、避免完成，还是避免遗憾或意外结果。", {
    usageNote: "肯定形式可以强调完成，也可以带有遗憾；否定形式根据语境可表示未完成、避免完成，或避免某个遗憾／意外结果。不要把一种中文释义当成所有否定句的硬限制。",
...
const COMPOUND_MEANINGS = {
  ...
  temiru: {
    past: ["试着做了……", "表示过去实际尝试了某个动作，以观察结果或获得体验。"],
    negative: ["不尝试做……", "表示不实际尝试某个动作。"],
    negativePast: ["过去没有尝试做……", "表示过去没有实际尝试某个动作。"],
  },
  teshimau: {
    past: ["做完了……／不小心做了……", "表示过去彻底完成了某个动作，也可表示过去意外或不由自主地做了某事。"],
    negative: ["没有……／避免……", "表示动作没有完成，或避免某个遗憾、意外或不可挽回的结果；由完整语境判断否定范围。"],
    negativePast: ["没有……／避免了……", "表示过去没有完成某事，或过去避免了某个遗憾、意外或不可挽回的结果；由完整语境判断否定范围。"],
  },
  teoku: {
