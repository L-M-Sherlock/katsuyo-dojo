...
const CONSTRUCTION_SEMANTICS = {
  ...
  zu: semantic("不……", "以较书面或固定的方式表示否定，相当于「ない」。", {
    register: "书面／较正式",
    usageNote: "「する」变为「せず」。",
  }),
  zuni: semantic("不做……而……", "表示没有进行前项动作便进行后项，相当于较书面的「ないで」。", {
    register: "书面／较正式",
    usageNote: "「する」变为「せずに」。",
  }),
  ...
  tearu: semantic("事先……好／结果状态／部分地区的尊敬表达", "通常表示有意完成动作后保留的结果状态，或为某个目的已经事先做完某事；福冈部分地区的同形也可尊敬地描述他人的动作或状态。", {
    usageNote: "标准语描述对象的结果状态时，常用他动词及「が」；事先完成用法也可用「を」。标明福冈地方语境的卡片可采用相当于「ていらっしゃる」的尊敬用法，不表示事先准备。",
    contrast: "标准语的「ている」可单纯描述进行或结果；「てある」突出人为准备及留下的状态。",
  }),
  ...
  toru: semantic("正在……／一直……／处于……状态", "是「ておる／でおる」缩成的「とる／どる」，含义仍与相应的「ておる」相同。", {
  ...
  tsutsu: semantic("一边……一边……", "表示同一主体同时进行两个动作，含义接近「ながら」。", {
    register: "书面／较正式",
  ...
  tewa: semantic("做……就……，如此反复", "表示前项发生后接着出现后项，这样的过程反复发生。", {
    usageNote: "本课练习反复用法；同形的「ては」也可用于条件或禁止表达。",
  }),
  ...
  temiru: semantic("试着做……／实际经历后……", "表示实际尝试某个动作，以观察结果或获得体验；在「〜てみると／〜てみたら」等语境中，也可表示实际经历某事后作出判断或发现。", {
    usageNote: "经历后的发现不一定是有意试做；「終わってみると」可表示结束后回头看，「終わってみないと分からない」表示不等到实际结束就无法判断。须结合后项理解。",
    contrast: "不同于表示视觉的「見る」；作为补助表达时通常写作假名「みる」。",
  }),
  teshimau: semantic("做完……／不小心……", "表示动作彻底完成，也可对动作或情况表达遗憾、意外或不由自主的语感；否定形由完整语境决定是未完成、避免完成，还是避免遗憾或意外结果。", {
    usageNote: "否定形可否定完成或某种结果；接「ように」等结构时可表达避免不愿发生的结果。过去否定疑问也可询问是否已经发生。具体含义由整句决定。",
    contrast: "口语常缩为「ちゃう／じゃう」。",
  }),
  chau: semantic("做完……／不小心……", "是「てしまう／でしまう」的口语缩约，含义仍是彻底完成或带遗憾、意外。", {
    register: "口语缩约",
    usageNote: "て接「ちゃう」，で接「じゃう」。",
  }),
  teoku: semantic("预先做……／保持……", "表示为将来预先完成动作，或做完后让结果状态保持不变。", {
    usageNote: "接「ほうがよかった」等建议或评价时，整句可表示本该事先如此，不等于该动作确实已经发生。否定条件可提出后事前须已达到的状态；过去否定疑问也可反问为何未在合适节点收尾。",
    contrast: "口语常缩为「とく／どく」。",
  }),
  toku: semantic("预先做……／保持……", "是「ておく／でおく」的口语缩约，表示预先准备或保持结果。", {
    register: "口语缩约",
    usageNote: "て接「とく」，で接「どく」。",
  }),
  teiku: semantic("继续下去／向远处而去", "表示动作或状态从某个时点向后持续、变化向后发展，或动作在空间上远离说话人。", {
    usageNote: "不一定表示逐渐变成另一状态；例如「今の人数で足りていくか」问现有人数今后是否持续够用。也可先做某事再离去；「来ていった」在转告访客的语境中可表示来过又走了。",
    contrast: "「てくる」常表示变化发展到现在，或动作朝说话人而来。",
  }),
  teku: semantic("继续下去／向远处而去", "是「ていく／でいく」的口语缩约，核心含义与「ていく」相同。", {
    register: "口语缩约",
  }),
  tekuru: semantic("逐渐……起来／……而来", "表示动作、状态或变化向某个观察时点持续、显现，朝说话人方向而来，或做完某事再回来。", {
    usageNote: "观察点也可以在将来；「工事が進むと材料が要ってくる」表示随着施工推进会出现材料需求。否定疑问可以询问某状态是否出现，不能一律译成确定没有发生。",
...
const ADJECTIVE_SEMANTICS = {
  ...
  adjectiveAttributive: semantic("……的", "让な形容词直接修饰后面的名词。", {
...
// A continuation changes the scope of the whole expression. Write each meaning
// explicitly instead of appending a tense label or negating the base text.
const COMPOUND_MEANINGS = {
  teageru: {
    past: ["为别人做了……", "表示过去为别人做了某事，给予对方帮助或恩惠。"],
    negative: ["不为别人做……", "表示不为别人做某事，不给予相应的帮助或恩惠。"],
    negativePast: ["过去没有为别人做……", "表示过去没有为别人做某事，没有给予相应的帮助或恩惠。"],
  },
  temorau: {
    past: ["得到了别人……的帮助", "表示过去接受了别人做某事所带来的帮助或恩惠。"],
    negative: ["不接受别人……的帮助", "表示不接受别人做某事所带来的帮助或恩惠。"],
  ...
  teiru: {
    ...
    negative: ["没有在……／没有处于……状态", "根据动词和语境，表示动作没有在进行、平时不做某事，或相应的结果状态不存在。"],
    negativePast: ["当时没有在……／当时没有处于……状态", "根据动词和语境，表示过去某时动作没有在进行、过去没有相应习惯，或当时不存在相应的结果状态。"],
  },
  tearu: {
    past: ["当时的准备结果／部分地区尊敬地叙述过去状态", "标准语表示过去某时人为准备的结果，或某事已事先完成；在标明福冈地方语境时，也可尊敬地描述他人当时的动作或状态。"],
  ...
  teoru: {
    ...
    negative: ["没有在……／没有处于……状态", "基本相当于「ていない」，表示动作没有在进行、平时不做某事，或相应的结果状态不存在。"],
    negativePast: ["当时没有在……／当时没有处于……状态", "基本相当于「ていなかった」，表示过去某时动作没有在进行、过去没有相应习惯，或当时不存在相应的结果状态。"],
  },
  tai: {
    past: ["过去想做……", "表示过去希望自己进行某个动作。"],
    negative: ["不想做……", "表示不希望自己进行某个动作。"],
  ...
  youtosuru: {
    ...
    negative: ["不肯……／不打算……", "表示没有做某事的意愿或尝试，描述他人时常有“不肯做”的语感。"],
    negativePast: ["当时不肯……／当时没有打算……", "表示过去某时没有做某事的意愿或尝试，描述他人时常有“当时不肯做”的语感。"],
  },
  temiru: {
    past: ["试着做了……／实际经历了……", "表示过去实际尝试了某个动作；接「ら」等构成「〜てみたら」时，也可引出实际经历后的判断或发现。"],
    negative: ["不尝试……／尚未实际经历……", "否定实际尝试；在「〜てみないと分からない」等条件句中，也可表示未实际经历就无法判断，整句不等于拒绝尝试。"],
    negativePast: ["过去没有尝试做……", "表示过去没有实际尝试某个动作。"],
  },
  teshimau: {
    past: ["做完了……／发生了意外的情况", "表示过去彻底完成了某个动作，也可对过去的动作或情况表达遗憾、意外或不由自主的语感。"],
    negative: ["不……完／不至于……", "否定动作的完成或某种结果；接「ように」等结构时可表达避免意外或不愿发生的结果。具体范围由完整语境判断。"],
    negativePast: ["没有……完／没有发生……", "否定过去的完成或结果；用于疑问时，也可询问是否已经发生了意外或不愿发生的结果。不能一律理解为避免成功或没有全部做完。"],
  },
  teoku: {
    past: ["预先做了……／保留了……", "表示过去为之后的事情预先做了准备，或做完某事后保留了结果状态。"],
    negative: ["不预先做……／不保留……", "表示不预先进行某个动作，或不让相应的结果状态保留下来。"],
    negativePast: ["过去没有预先做……／没有保留……", "表示过去没有预先进行某个动作，或没有保留相应的结果状态。"],
  },
  teiku: {
    past: ["继续……下去了／……而去了", "表示动作或状态从过去某时持续下去、变化继续发展、当时伴随某个动作向远处移动，或先做某事再离去。"],
    negative: ["不继续……下去／不……而去", "否定动作或状态的持续、变化的继续发展，或伴随动作离去、做完某事再离去；用于否定疑问时也可征求认同，不能一律理解为事情不发生。"],
    negativePast: ["当时没有继续……下去／没有……而去", "否定过去某时的持续发展、伴随动作离去或做完某事再离去；用于否定疑问时也可确认事情是否已经发生。具体否定范围由完整语境决定。"],
  },
  tekuru: {
    past: ["逐渐……起来了／……而来了／……后回来了", "表示动作、状态或变化已持续或显现至某个时点、伴随某个动作朝说话人移动，或做完某事后返回。"],
    negative: ["没有逐渐……起来／不……而来／不去……再回来", "否定相应状态或变化的出现、伴随某个动作朝说话人移动，或去做某事后返回；否定疑问也可询问是否出现。"],
    negativePast: ["当时没有逐渐……起来／没有……而来／当时没有去……再回来", "否定过去某时相应状态或变化的出现、伴随某个动作朝说话人移动，或去做某事后返回；否定疑问也可确认当时是否出现。"],
  },
  sugiru: {
    past: ["做得过头了／过于……了", "表示过去的动作或性质超过了合适、正常的程度。"],
    negative: ["不会做得过头／不过于……", "表示动作或性质没有超过合适、正常的程度。"],
    negativePast: ["没有做得过头／当时不过于……", "表示过去的动作或性质没有超过合适、正常的程度。"],
  },
  tagaru: {
    past: ["当时显得想做……", "根据过去可观察到的表现，描述第三人当时想做某事。"],
    negative: ["没有表现出想做……的意愿", "表示从可观察到的表现看，第三人没有显露出做某事的愿望。"],
    negativePast: ["当时没有表现出想做……的意愿", "表示从过去可观察到的表现看，第三人当时没有显露出做某事的愿望。"],
  },
};

function compoundSemantic(form, spec) {
  const base = STATIC_FORM_SEMANTICS[spec.form];
  const meaning = COMPOUND_MEANINGS[spec.form]?.[spec.ending];
  if (!base || !meaning) throw new Error(`Missing compound semantics for ${form}`);
  return semantic(meaning[0], meaning[1], {
    ...(base.register ? { register: base.register } : {}),
    ...(base.usageNote ? { usageNote: base.usageNote } : {}),
    ...(base.contrast ? { contrast: base.contrast } : {}),
    baseForm: spec.form,
