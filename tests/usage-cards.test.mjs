...
test('published action cards match the approved review ledger and leave the historical baseline intact', () => {
  ...
  assert.equal(sourceHash('../docs/usage-card-actions-review.json'), '34f48c6f9cf3f7ef440f3409d589443dd8987898e33a0ae93e4f68b686b1dd4f');
  assert.equal(sourceHash('../app/lib/usage-cards/actions-generated.mjs'), '5f950fd1c3deba5ae66657c7bd709ee151ecf6387e47baeabcca2650a11eeb44');
  ...
  assert.equal(pendingPairs.size, 66);
