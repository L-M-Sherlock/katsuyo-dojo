import { USAGE_CARDS, usageCardIssues, resolveUsageCard, usageCardItem, usageCardClassRequirements, basicUsageCardRequirements, usageCardWritingReview } from '../app/lib/usage-cards.mjs';

const strict = !process.argv.includes('--draft');
const issues = usageCardIssues(USAGE_CARDS, {requireCoverage: strict, requireClassCoverage: strict, requireBasicCoverage: strict});
...
console.log(JSON.stringify({cards: USAGE_CARDS.length, approved: approved.length,
  ...
  requiredBasicPairs: basic.size, writingReview: usageCardWritingReview(USAGE_CARDS), issues}, null, 2));
