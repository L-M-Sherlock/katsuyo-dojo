import { USAGE_CARDS, usageCardIssues, resolveUsageCard, usageCardItem, usageCardClassRequirements, basicUsageCardRequirements } from '../app/lib/usage-cards.mjs';
...
console.log(JSON.stringify({cards: USAGE_CARDS.length, approved: approved.length,
  ...
  requiredBasicPairs: basic.size, issues}, null, 2));
