...
2026-09-21 Windows 已完成 82 个协议 3 批次的全部合并和审核。当前发布范围与完整覆盖见 [发布记录](integration-release.md) 和 [v3 账本](integration-stage-requirements.v3.json)。运行时应为 17,606 张，综合运用 1,301 张；原有 16,412 张未改变。
